...
class PlanLocationView: UIViewController{
    ...
    //IMPROVE if edit plan then get image from realm
    ...
    lazy var stackView: UIStackView = {
        ...
        stackView.distribution = .equalSpacing //DO NOT CHANGE
...
//delegate from date picker view
